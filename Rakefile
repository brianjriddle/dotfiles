...
rc_files = %w{DIR_COLORS ackrc antopts bash_logout bash_profile bashrc curlrc gemrc gitconfig gitignore irbrc js profile rspec rvmrc tidyrc tmux.conf Xresources zshenv zshrc}
